...
1. 从 GitHub Actions 的 `peerbander-beyonder-ds1823xs-0.0.1-amd64` 构建产物下载 TAR。
...
```bash
npm test
docker build --platform linux/amd64 -t peerbander-beyonder:0.0.1 .
docker save -o peerbander-beyonder-ds1823xs-0.0.1-amd64.tar peerbander-beyonder:0.0.1
```
